...
text from the fonts installed on the host — that part takes three crates, and
is what macOS gets by default; see [INTERNALS.md](INTERNALS.md).
...
![The Self 4.4 demo world, booted by serf](https://raw.githubusercontent.com/mkmik/serf/main/shots/20-demo-4.4-native.png)
